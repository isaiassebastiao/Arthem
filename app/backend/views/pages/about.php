...
<main>
    <section class="about-main-section">
        ...
        <section class="about-section-2">
            <h2>Missão</h2>
            <p>Fortalecer a presença dos artistas angolanos no cenário cultural e digital, permitindo que suas obras sejam descobertas, apreciadas e adquiridas com total transparência e simplicidade.</p>
        </section>
    
        <section class="about-section-3">
            <h2>O que você encontra aqui</h2>
            <div class="what-will-you-find-here">
                <div>
                    <p>
                        <strong>Perfis completos de artistas: </strong>Cada criador possui biografia, contactos e categorias de atuação.
                    </p>
                </div>
                <div>
                    <p>
                        <strong>Obras catalogadas com rigor: </strong>Título, foto, descrição, dimensões e estado de disponibilidade.
                    </p>
                </div>
                <div>
                    <p>
