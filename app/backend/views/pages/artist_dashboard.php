...
<body>
    ...
    <main class="container" data-id="<?=$_SESSION['id']?>" data-name="<?=$_SESSION['name']?>">
        <aside class="sidebar">
        ...
        <div class="publish-update-artworks-container">
            ...
            <form class="card" id="publish_artwork_modal">
                ...
                <div class="input-group textarea">
                    ...
                    <textarea placeholder="Dê uma breve descrição da sua obra" maxlength="200" required name="description"></textarea>
                </div>
            ...
            <form class="card" id="update_artwork_modal">
                ...
                <div class="input-group textarea">
                    <i class='bx bx-align-left'></i>
                    <textarea placeholder="Dê uma breve descrição da sua obra" required name="description" maxlength="200" id="description"></textarea>
                </div>
